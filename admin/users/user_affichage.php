                                ...
                                <?php
                                            foreach($c as $a)  {
                                                    echo "<tr>
                                                            ...
                                                            <td><a href=" . "user_update.php/?id=" . $a->id. " class='btn edit'  style='color:#007bff; ' title='Modier les infos'><i class='fa-solid fa-pen-to-square'></i></a>
                                                            <a  href=" . "user_archive.php/?id=" . $a->id . "  class='btn edit' style='color:#f16c69; ' title='Désactiver ce compte'><i class='fa-solid fa-ban'></i></a>
                                                            </td>
                                                        </tr>";
                                            }
                                        ?>
