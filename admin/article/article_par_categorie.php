...
$query = mysqli_query($db, "SELECT `articles`.`id` AS `id`, `title`, `content`, `date`, `image`, `name`, `username`
                            ...
                            WHERE `articles`.`isValidate` = 1 AND archive=0 AND `categories`.`id`=$id
                            ORDER BY `date` DESC");
                        ...
                        <div class="hero__slide-thumb-text-holder">
                            <div class="container">
                                <a href="categories.html"
                                    class="entry__meta-category entry__meta-category--label">Devnano</a>
                                <h2 class="entry__title entry__title--white"
                                    style="font-size: 36px; margin-top: 10px; max-width: 700px;">
                                    <a>Uncovering and explaining how our digital world is changing — and changing
                                        us.</a>
             ...
             ?>
                ...
                <aside class="col-md-4 sidebar sidebar--right">
                   ...
                   while ($row = mysqli_fetch_array($categorie)) {
                        ?>
                            <li>
                                <a class="social-facebook" href="article_par_categorie.php?id=<?=$row['id'];?>"
                                    target="_blank">
                        ...
                        <div class="col-lg-9 col-md-6" style="padding-left=350px;">
                            <div class="widget">
                                ...
                                <div class="socials mt-20">
                                    <a href="https://www.facebook.com/devosoftma" class="social-facebook"
                                        aria-label="facebook"><i class="ui-facebook"></i></a>
                                    <a href="#" class="social-twitter" aria-label="twitter"><i
                                    ...
                                    <a href="https://www.instagram.com/devosoft_agency" class="social-instagram"
